...
public final class AudioRecorder extends BaseAudio {
    ...
    private int readBufferSzie = 1024*2;
...
//                });
    ...
    public void doRun() {
        try {
            ...
            final byte[] audio_data = new byte[readBufferSzie];
            while (isRuning()) {
                //如果是暂停状态不录音
                if (mPause) {
                ...
                bufferReadResult = mAudioRecord.read(audio_data, 0, 320);
    ...
    public interface IAudioDecoder {
         ...
         */
        void decoderData(byte[] audio_data, int bufferReadResult)throws Exception;
